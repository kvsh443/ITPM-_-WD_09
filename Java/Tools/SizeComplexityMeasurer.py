...
class SizeComplexityMeasurer(object):
    ...
    def get_keywords(self):
        keyword_list = ["abstract", "assert", "break", "catch", "class", "continue", "default", "enum", "exports",
    ...
    def get_identifiers(self):
        identifier_list = ["boolean", "byte", "char", "class", "double", "float", "int", "long", "short", "string",
                           "String",
                           "ArrayList", "List", "HashMap", "void"]
        identifiers = []
