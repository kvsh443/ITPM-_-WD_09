...
# don't change the order unless you change order accordingly in calculate.py
class Helper:
    code = ""
    result = {}
    method_complexity = {}
    ...
    def run(self):
        ...
        for i in range(0, len(lines)):
            inheritance_complexity[i] = [lines[i], ih.get_ndi()[i], ih.get_complexity()[i],
                                         ih.get_complexity()[i], ih.get_complexity()[i]]
