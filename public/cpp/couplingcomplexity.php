...
<body>
    ...
    <div style="margin-top:20px; margin-right:20px; margin-left:20px;">
        <div class="row">
            <div class="col-sm-9">
                <h1>Complexity of a program due to Coupling</h1>
            </div>
            <div class="col-sm-3">
                <ul class="pagination">
                    <li><a href="#">1</a></li>
...
// REST API End point
$url = 'http://measurecomplexity2.herokuapp.com/codecomplexity/coupling_structures';
...
echo '<div class="container" style="margin-top:20px;">
    ...
    <div class="col-sm-3">
                <form action="methodcomplexity.php" method="POST" class="float-right">
    ...
    <div class="col-sm-3">
        <form action="controlstructurescomplexity.php" method="POST" class="float-right">';
